    ...
    provideAnimationsAsync(),
    {
      ...
      useFactory: (iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) => () => {
        ...
        if (isFileProtocol) {
          ...
          iconRegistry.addSvgIconLiteral('close', sanitizer.bypassSecurityTrustHtml(iconLiterals.close));
          iconRegistry.addSvgIconLiteral('moon', sanitizer.bypassSecurityTrustHtml(iconLiterals.moon));
          iconRegistry.addSvgIconLiteral('sun', sanitizer.bypassSecurityTrustHtml(iconLiterals.sun));
          return;
        }

        iconRegistry.addSvgIcon('down-arrow', sanitizer.bypassSecurityTrustResourceUrl(iconPaths.downArrow));
        iconRegistry.addSvgIcon('right-arrow', sanitizer.bypassSecurityTrustResourceUrl(iconPaths.rightArrow));
