    ...
    provideAnimationsAsync(),
    {
      ...
      useFactory: (iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) => () => {
        ...
        const iconPaths = {
          ...
          gripLines: 'assets/icons/grip-lines.svg',
        ...
        const iconLiterals = {
          ...
          gripLines:
            '<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><title>Grip-lines SVG Icon</title><path fill="currentColor" d="M496 288H16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h480c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16m0-128H16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h480c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16"/></svg>',
        };
        ...
        if (isFileProtocol) {
          ...
          iconRegistry.addSvgIconLiteral(
            'grip-lines',
            sanitizer.bypassSecurityTrustHtml(iconLiterals.gripLines),
          );
          return;
        }
        ...
        iconRegistry.addSvgIcon(
          'grip-lines',
          sanitizer.bypassSecurityTrustResourceUrl(iconPaths.gripLines),
        );
      },
    },
  ],
